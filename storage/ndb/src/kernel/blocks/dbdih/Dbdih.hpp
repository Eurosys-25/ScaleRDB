...
private:
  ...
  MutexHandle2<DIH_START_LCP_MUTEX_KCJ> c_startLcpMutexHandle_KCJ;
  void startLcpMutex_locked_KCJ(Signal* signal, Uint32, Uint32);
  void startLcpMutex_unlocked_KCJ(Signal* signal, Uint32, Uint32);
...
//------------------------------------
  ...
  void startLcpRoundLab_KCJ(Signal *);
