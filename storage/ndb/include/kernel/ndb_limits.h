...
#define STATIC_ASSERT_KCJ(expr, msg) \
    { typedef CompileTimeChecker<(expr) != 0> ERROR_##msg; (void)ERROR_##msg; }
*/
...
//STATIC_ASSERT_KCJ(MAX_REPLICAS >= 4, MAX_REPLICAS_must_be_4_or_greater);
...
static inline void ndb_limits_constraints()
{
 ...
 NDB_STATIC_ASSERT(MAX_REPLICAS >= 4);
